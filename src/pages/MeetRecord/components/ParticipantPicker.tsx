...
function ParticipantPicker({ participants, onParticipantToggle }: ParticipantPickerProps) {
  ...
  return (
    ...
    >
      <AddMemberAvatar size="md" borderWeight="thin" aria-label="참가자 추가" />

      {participants.map((participant) => {
        const isSelected = Boolean(participant.selected);
